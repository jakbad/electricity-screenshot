...
def generate_plot(save_path=None, nuclear_ref=0.540):
...
#    ax.hlines(max_val, xmin=times_raw[0], xmax=times_raw[max_idx], colors='red', linestyles='--', linewidth=1)
    ax.axhlines(min_val, colors='blue', linestyles='--', linewidth=1)
    ax.axhlines(max_val, colors='red', linestyles='--', linewidth=1)
